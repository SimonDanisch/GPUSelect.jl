...
- `install=true` — **EXPERIMENTAL** call `auto_install!()` automatically if no backend is found (default: value of `get_install_preference()`). Still needs some investigation if this is a good idea!
